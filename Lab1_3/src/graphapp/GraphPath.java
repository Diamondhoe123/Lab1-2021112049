...
public class GraphPath extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Map.Entry<String, Map<String, Integer>> entry : graph.entrySet()) {
            ...
            for (Map.Entry<String, Integer> edge : entry.getValue().entrySet()) {
                ...
                drawCurvedArrowLine(g2d, startPoint.x, startPoint.y, endPoint.x, endPoint.y, isHighlighted); // 画箭头线
                g2d.setColor(Color.BLACK);
                g2d.drawString(String.valueOf(weight), (startPoint.x + endPoint.x) / 2, (startPoint.y + endPoint.y) / 2);
            }
        }
    ...
    private void drawCurvedArrowLine(Graphics2D g2d, int x1, int y1, int x2, int y2, boolean isHighlighted) {
        int arrowLength = 11; // 箭头的长度
        int arrowWidth = 8;  // 箭头的宽度
        ...
        // 计算终点的切线方向
        double t = 0.95; // 在曲线上的位置，取值范围在0到1之间
